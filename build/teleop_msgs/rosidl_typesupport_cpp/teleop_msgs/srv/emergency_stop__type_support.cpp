...
static const _EmergencyStop_Request_type_support_symbol_names_t _EmergencyStop_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleop_msgs, srv, EmergencyStop_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, teleop_msgs, srv, EmergencyStop_Request)),
  }
};
...
{
  return &::teleop_msgs::srv::rosidl_typesupport_cpp::EmergencyStop_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, teleop_msgs, srv, EmergencyStop_Request)() {
  return get_message_type_support_handle<teleop_msgs::srv::EmergencyStop_Request>();
}
...
static const _EmergencyStop_Response_type_support_symbol_names_t _EmergencyStop_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleop_msgs, srv, EmergencyStop_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, teleop_msgs, srv, EmergencyStop_Response)),
  }
};
...
{
  return &::teleop_msgs::srv::rosidl_typesupport_cpp::EmergencyStop_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, teleop_msgs, srv, EmergencyStop_Response)() {
  return get_message_type_support_handle<teleop_msgs::srv::EmergencyStop_Response>();
}
...
static const _EmergencyStop_type_support_symbol_names_t _EmergencyStop_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleop_msgs, srv, EmergencyStop)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, teleop_msgs, srv, EmergencyStop)),
  }
};
...
{
  return &::teleop_msgs::srv::rosidl_typesupport_cpp::EmergencyStop_service_type_support_handle;
}
