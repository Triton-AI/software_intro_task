...
#include "teleop_msgs/srv/detail/emergency_stop__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const teleop_msgs::srv::EmergencyStop_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<teleop_msgs::srv::EmergencyStop_Request *>(
    untyped_ros_message);
...
{
  return max_serialized_size_EmergencyStop_Request(full_bounded, 0);
}
...
{
  return &teleop_msgs::srv::typesupport_fastrtps_cpp::_EmergencyStop_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const teleop_msgs::srv::EmergencyStop_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<teleop_msgs::srv::EmergencyStop_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return max_serialized_size_EmergencyStop_Response(full_bounded, 0);
}
...
{
  return &teleop_msgs::srv::typesupport_fastrtps_cpp::_EmergencyStop_Response__handle;
}
...
{
  return &teleop_msgs::srv::typesupport_fastrtps_cpp::_EmergencyStop__handle;
}
