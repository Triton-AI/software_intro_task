...
{
  teleop_msgs__msg__VehicleControlData * msg = (teleop_msgs__msg__VehicleControlData *)malloc(sizeof(teleop_msgs__msg__VehicleControlData));
  if (!msg) {
    return NULL;
  }
...
teleop_msgs__msg__VehicleControlData__Sequence__init(teleop_msgs__msg__VehicleControlData__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (teleop_msgs__msg__VehicleControlData *)calloc(size, sizeof(teleop_msgs__msg__VehicleControlData));
    if (!data) {
      return false;
    }
...
{
  teleop_msgs__msg__VehicleControlData__Sequence * array = (teleop_msgs__msg__VehicleControlData__Sequence *)malloc(sizeof(teleop_msgs__msg__VehicleControlData__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  teleop_msgs__msg__VehicleControlData__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    teleop_msgs__msg__VehicleControlData * data =
      (teleop_msgs__msg__VehicleControlData *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!teleop_msgs__msg__VehicleControlData__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          teleop_msgs__msg__VehicleControlData__fini(&data[i]);
        }
        free(data);
        return false;
      }
